...
public class TransactionController {
    ...
    public ResponseEntity<com.finance.app.dto.CsvImportSummaryDTO> importCsv(
            @Parameter(description = "Account ID to associate imported transactions with") @RequestParam @Positive(message = "Account ID must be greater than zero") Long accountId,
    ...
    public ResponseEntity<Page<TransactionResponseDTO>> getTransactions(
            @Parameter(description = "Filter by Account ID") @RequestParam(required = false) @Positive(message = "Account ID must be positive") Long accountId,
            @Parameter(description = "Filter by Category ID") @RequestParam(required = false) @Positive(message = "Category ID must be positive") Long categoryId,
    ...
    public ResponseEntity<TransactionResponseDTO> getTransactionById(@PathVariable @Positive(message = "Transaction ID must be greater than zero") Long id) {
    ...
    public ResponseEntity<Void> deleteTransaction(@PathVariable @Positive(message = "Transaction ID must be greater than zero") Long id) {
